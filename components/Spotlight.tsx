...
const Spotlight = (props) => {
  return (
    <div className="flex flex-row items-center justify-start w-3/4 mt-5 mx-5 px-4 xl:py-10 lg:mt-10 xl:w-1/2 bg-egg-200 text-white dark:bg-zinc-800 duration-500 rounded-3xl drop-shadow-xl">
